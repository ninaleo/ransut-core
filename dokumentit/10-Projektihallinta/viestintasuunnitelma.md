...
Projektiin liittyvässä kirjallisessa viestinnässä käytetään......
...
Portfolio- projektin sisäisessä viestinnässä käytetään sekä formaaleja että epävirallisia kanavia.
...
Dokumentaatiota päivittäisestä työskentelystä voi jokainen seurata Gitissä.
